...
import { View, Text, StyleSheet, TouchableOpacity, Dimensions, ScrollView, Alert, Image } from 'react-native';
import * as DocumentPicker from 'expo-document-picker';
import { SafeAreaView } from 'react-native-safe-area-context';
import { StatusBar } from 'expo-status-bar';
import { ChevronLeft, Plus, Edit2, Layers, FileSpreadsheet, Maximize2, Users, DollarSign, Upload } from 'lucide-react-native';
...
const AdminLayoutScreen = ({ navigation }) => {
  ...
  const renderSectorBlock = (sector) => {
    ...
    if (sector.id === 'south') {
      sectorStyle = { bottom: '22%', alignSelf: 'center', width: 140, height: 90 };
      ...
      >
        <View style={styles.sectorContent}>
          ...
          <View style={styles.badgeContainer}>
             <Text style={styles.sectorBadgeText}>${sector.price}</Text>
          </View>
        </View>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerActions}>
            <TouchableOpacity style={styles.actionIconButton} onPress={handleImportExcel}>
              <Upload size={20} color={COLORS.gray600} />
            </TouchableOpacity>
            <TouchableOpacity style={[styles.actionIconButton, { backgroundColor: COLORS.brandPurple }]}>
        ...
        <View style={styles.bottomSheet}>
          {selectedSector ? (
            <View>
              <View style={styles.sheetHeader}>
                <View>
                  ...
                  <Text style={styles.sheetSubtitle}>{selectedSector.type.toUpperCase()} TIER</Text>
                </View>
                <TouchableOpacity onPress={() => setSelectedSector(null)} style={styles.closeBtn}>
              ...
              <View style={styles.metricsGrid}>
                 <View style={styles.metricCard}>
                   <Users size={20} color={COLORS.brandPurple} style={{marginBottom: 8}} />
                 ...
                 <View style={styles.metricCard}>
                   ...
                   <Text style={styles.metricValue}>${selectedSector.price}</Text>
                 </View>
                 <View style={styles.metricCard}>
                   <Maximize2 size={20} color={COLORS.secondary} style={{marginBottom: 8}} />
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyDesc}>Tap on any stadium sector to view details, edit pricing, or configure seating arrangements.</Text>
              
              <TouchableOpacity style={styles.importBanner} onPress={handleImportExcel}>
                 <FileSpreadsheet size={20} color={COLORS.brandPurple} />
                 <Text style={styles.importBannerText}>Import Configuration from Excel</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
