...
import { ChevronLeft, User, ShieldCheck, Check, ChevronRight, Crown } from 'lucide-react-native';
    ...
    >
      ...
      <View style={styles.cardContent}>
        <View style={styles.cardHeader}>
          <Text style={[styles.cardTitle, isSelected && styles.cardTitleActive]}>{title}</Text>
          {isPro && (
        ...
        <Text style={[styles.cardDescription, isSelected && styles.cardDescriptionActive]}>{description}</Text>
      </View>
        ...
        <View style={styles.content}>
          <View style={styles.titleWrapper}>
            ...
            <Text style={styles.subtitle}>
              Personalize your platform experience by selecting your primary role.
            </Text>
          </View>
          ...
          <View style={styles.cardsWrapper}>
            <RoleCard
              ...
              icon={<User size={28} color={selectedRole === 'fan' ? '#ffffff' : '#1d3557'} />}
            ...
            <RoleCard
              ...
              icon={<ShieldCheck size={28} color={selectedRole === 'admin' ? '#ffffff' : '#1d3557'} />}
          ...
          <View style={styles.infoBox}>
              <Text style={styles.infoText}>
                  You can always switch or link multiple accounts later in your profile settings.
              </Text>
          </View>
        </View>
